function opt_process_closeloop(problem, queueEventPool, queuePollableWorkerPool)
    ...
    problem.objective = @(value) opt_obj_fcn(problem.func_norm, value, problem.index, problem.seeding, queueEventPool, queuePollableWorkerPool);
    ...
    try
        ...
        send(queueEventPool.logger, 'OPT: error has arose, optimization is terminated');
    end
